...
public class OAuth2ClientTokenServices implements ClientTokenServices {
	...
	//@formatter:off
	/*By implementing ClientTokenServices, the client application is able to retrieve, save, or
	remove an access token from its database, allowing you to choose where to save this data.
	For example, you might use another kind of database.*/
