...
public class ClientConfiguration {
	...
	public OAuth2ProtectedResourceDetails implicitResourceDetails() {
		...
		/*we are not setting up the client secret and the token endpoint. This
		makes sense because the Implicit grant type uses the authorization endpoint to deliver the
		access token implicitly in such a way that the client does not need to make a request for the
